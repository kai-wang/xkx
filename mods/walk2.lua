...
blocker_npcs["张松溪"] = {id = "zhang songxi", pfm = true, exp=2000000}
blocker_npcs["莫声谷"] = {id = "mo shenggu", pfm = true, exp=2000000}
	...
	["thmz"] = function(dir)
		wait.make(function()
			...
			repeat
				...
				count = count + 1
				wait.time(2)
			until((l ~= nil and l:match("终于走出了桃花迷阵")) or count > 10) 

			if(l ~= nil and l:match("终于走出了桃花迷阵")) then
				handlers.done()
			else
				handlers.fail()
			end
