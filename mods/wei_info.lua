...
local wei_buy_items = {
	...
	{"花雕酒袋",		"yz;#2 e;u;buy jiudai",			"jiudai"},
	{"蓝宝石腰带",		"ne;buy yao dai",				"dai"},
	{"肉包子",			"yz;#2 e;buy baozi",			"baozi"},
	{"皮靴",			"ne;d;buy xue",					"xue"},
	...
	{"蛇肉",			"bts;sd;s;#2 (sd);se;e;n;buy rou","rou"},
...
local wei_kill_item = {
	...
	{"三股叉",		"sangu cha",		"侯通海",		"yz;e;n;w;w;w;n;n;e;ne;n;k2 hou tonghai"},
	...
	{"红衣",		"hong yi",		"门卫",		"yz;e;n;e;k1 men wei"},
	{"银剑",		"yin jian",		"门卫",		"yz;e;n;e;k2 wei"},
	...
	{"铁桨",		"tie jiang",		"沙通天",		"yz;hh;k2 sha tongtian"},
	...
	{"长枪",		"chang qiang",		"蒙古兵",		"yz;hh;e;k2 menggu bing"},
	...
	{"白布长袍",		"chang pao",		"常金鹏",		"cqz;k1 chang jinpeng"},
	...
	{"灰布镶边袈裟",		"jia sha",		"道明小师父",		"cem;em1b;enter;n;k1 daoming xiaoshifu"},
	...
	{"镔铁判官笔",		"panguan bi",		"彭连虎",		"yz;hh;k2 peng lianhu"},
	...
	{"葛布长袍",		"chang pao",		"梁子翁",		"yz;hh;k1 liang ziwen"},
...
local wei_get_item = {
	...
	{"拂尘",		"emei;s;enter;s;e;#3 s;get fu chen",		 "fu chen"},
	...
	{"云龙经",		"weid=jing;tdh;e;get yunlong jing",		 "yunlong jing"},
	{"血竭",		"wg;#6 s;pull drawer;d;se;get xuejie",		 "xuejie"},
	{"茯苓",		"wg;w;w;w;ne;eu;ne;nu;nu;e;nu;kan frutex",		 "fuling"},
	{"重阳令",		"d;w;n;w;w;give daoren 1 gold;halt;e;e;s;e;u;giv ling"},
	{"野菜汤碗",		"xi;w;w;s;s;s;s;serve;drop fan",		 "wan"},
	{"西红柿蛋汤",		"cyz;e;n;e;e;s;s;serve;drop fan",		 "tang"},
	{"百合花",		"fs;n;#7 w;nw;sw;w;get hua",		 "hua"},
	{"大石头",		"d;w;s;s;e;e;get shi tou;w;w;n;n;e;u;giv shi tou"},
	{"大树枝",		"sz;w;#3 n;sw;get shu zhi",		 "shu zhi"},
	{"扬州炒饭",		"weib;e;n;e;e;s;s;serve;drop tangcwe;giv fan"},
	{"少林英雄令",		"d;w;s;give seng 1 gold;halt;n;e;u;giv ling"},
	...
	{"大酒坛",		"bj;zjc;e;get tan",		 "tan"},
	{"法轮",		"xs;n;#3 w;get fa lun;halt",		 "fa lun"},
	...
	{"白棋子",		"cyz;get 1 baiqi zi from xiang;we;giv baiqi zi"},
	{"黑棋子",		"cyz;get 1 heiqi zi from xiang;we;giv heiqi zi"},
	{"赏善铜牌",		"sz;#2 w;get shan pai from xiang",		 "shan pai"},
	{"引路神蛇",		"bts;#3 n;w;d;get shen she;e;#2 s;e;u;giv shen she"},
	...
	{"清水葫芦",		"emei;s;enter;s;e;#2 s;get qingshui hulu",		 "qingshui hulu"},
	{"菠菜粉条",		"emei;s;enter;s;e;#2 s;get bocai fentiao",		 "bocai fentiao"},
	{"素鸡",		"cem;ed;d;ne;ed;ne;ed;sd;#2 se;ed;s;enter;w;get suji",		 "suji"},
	{"素鸭",		"cem;ed;d;ne;ed;ne;ed;sd;#2 se;ed;s;enter;w;get suya",		 "suya"},
	{"珊瑚白菜",		"emei;s;enter;s;e;#2 s;get shanhu baicai;cmj;s;sd;w;drop shanhu baicai;get shanhu baicai",		 "shanhu baicai"},
	{"麻辣豆腐",		"cem;ed;d;ne;ed;ne;ed;sd;#2 se;ed;s;enter;w;get mala doufu;cmj;s;sd;w;drop mala doufu;get mala doufu",		 "mala doufu"},
	{"琉璃茄子",		"emei;s;enter;s;e;#2 s;get liuli qiezi;cmj;s;sd;w;drop liuli qiezi;get liuli qiezi",		 "liuli qiezi"},
	{"皮腰带",		"emei;s;enter;s;e;#3 s;get yao dai",		 "yao dai"},
	{"蛋糕",		"bts;#3 n;e;get dangao",		 "dangao"},
	{"蜂浆瓶",		"gm;n;e;e;get ping",		 "ping"},
	{"冰雪翡翠糕",		"lj;n;#3 w;get gao",		 "gao"},
	{"短剑",		"d;w;n;w;#3 s;get duan jian;#3 n;e;s;e;u;giv duan jian"},
	{"鱼翅",		"bj;zjc;e;get chi",		 "chi"},
	...
	--{"意形步法",		"sld;#3 s;w;#2 n;ask lu about 秘籍;cyz;e;#3 s;e;sell shoufa book;#alarm +1 {u;giv bufa book}"},
	--{"神龙八式手法",		"sld;#3 s;w;#2 n;ask lu about 秘籍;cyz;e;#3 s;e;sell bufa book;#alarm +1 {u;giv shoufa book}"},
	...
	{"阴阳合和散",		"cyz;get yinyang san from xiang;we;giv san"},
	{"钢剑",		"tzf;e;n;get gang jian",		 "gang jian"},
	{"鸟羽大氅",		"sb;d;w;n;enter dong;an;d;9;#2 sw;out;u;#2 wu;su;wu;su;ub;enter;get da chang",		 "chang"},
	{"酸梅汤",		"lj;n;#3 w;get tang",		 "tang"},
	{"豆浆",		"bts;#3 n;e;get jiang",		 "jiang"},
	{"香茶",		"yzw;#2 s;get xiang cha",		 "xiang cha"},
	{"无名花",		"sld;#3 s;#2 w;get wuming hua",		 "wuming hua"},
	{"尸骨",		"xy;#2 se;#3 w;get shi gu",		 "shi gu"},
	{"海口大碗",		"bts;n;w;s;get haikou dawan",		 "haikou dawan"},
	{"红绸",		"mz;n;n;n;w;push eye;climb ti zi;jump shu jia;get all;tear chou;cyz;drop xue yi;we;giv chou"},
	{"血棋衣",		"mz;n;n;n;w;push eye;climb ti zi;jump shu jia;get all;tear chou;cyz;drop hong chou",		 "yi"},
	{"草莓",		"bts;sd;s;#2 sd;#2 nw;n;w;sw;get cao mei",		 "cao mei"},
	{"生了锈的铡刀",		"lz;e;n;get rusty blade",		 "rusty blade"},
	{"大珍珠",		"jx;n;out;#2 d;#2 s;get da zhenzhu",		 "da zhenzhu"},
	{"石块",		"qz;#4 w;#2 sw;get shi",		 "shi"},
	{"棒法通解",		"d;w;n;enter dong;an;#2 d;w;break wall;get stick book",		 "stick book"},
}