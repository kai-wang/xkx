...
wei_kill_items = {
	...
	["柴刀"] = {"chai dao",	"樵夫",	"bt;sd;s;#2 (sd);#2 (nw);k2 qiao"},	
	...
	["圆领小袄"] = {"xiao ao",	"台夷猎人",	"dl;s;w;#9 s;e;e;k1 lie"},	
	["药粉"] = {"yao fen",	"小桂子",	"ne;d;n;e;e;e;e;k1 xiao guizi"},	
	["大斧头"] = {"da futou",	"樵夫",	"yd;n;ne;k2 fu"},	
	["台夷筒裙"] = {"tong qun",	"采笋人",	"dl;s;w;#8 s;sw;sw;w;k1 ren"},	
	...
	["铜钥匙"] = {"baituo yaoshi",	"管家",	"bt;#2 n;k1 guan"},	
	...
	["布衣"] = {"bu yi",	"挑夫",	"ne;d;n;#3 e;k1 porter"},	
	...
	["台夷短裙"] = {"duan qun",	"台夷商贩",	"dl;s;w;#9 s;e;k1 shang"},	
	...
	["毛毯"] = {"mao tan",	"农夫", "fly dl;s;w;n;e;eu;e;ed;se;sd;eu;ed;e;ne;e;e;se;eu;ed;sw;su;sd;e;n;k2 fu"},	
	["犁头"] = {"li tou",	"农夫", "fly dl;s;w;n;e;eu;e;ed;se;sd;eu;ed;e;ne;e;e;se;eu;ed;sw;su;sd;e;n;k2 fu"},	
	...
	["木柴"] = {"mu chai",	"樵夫",	"bt;sd;s;#2 (sd);#2 (nw);k1 qiao"},	
	...
	["大马棒"] = {"mabang",	"马贼",	"yd;n;ne;n;nw;n;#4 (ne);se;s;k1 zei"},	
	["锄头"] = {"chu tou",	"农夫",	"dl;s;w;n;w;w;wu;wd;wd;s;s;se;e;k1 fu"},	
	...
	["乌夷大麾"] = {"da hui",	"乌夷商贩",	"dl;s;w;n;w;w;w;wu;wd;wd;n;k1 shang"},	
	["葛布长袍"] = {"chang pao",	"梁子翁",	"hh;s;#3 (w);k1 liang ziwen"},	
	["台夷头巾"] = {"tou jin",	"台夷猎人",	"dl;s;w;#9 s;e;e;k1 lie"},	
	["独脚铜人"] = {"dujiao tongren",	"滕一雷",	"gw;n;n;k2 teng"},	
	["铁锹"] = {"tie qiao",	"采石人",	"yd;n;ne;n;nw;n;#4 (ne);se;k2 ren"}
}
...
wei_get_items = {
	...
	["皮腰带"] = {"em2;s;enter;|!k1::s|;e;#3 s;get yao dai", "yao dai"},
