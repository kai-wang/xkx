...
function fight_wear(f_done)
	wait.make(function()
		Execute("tuo all;wear shentong xue;wear bagua xue;wear shenshui mao;wear haoqi yi;wear tianlong yi;wear lianyu hushou;wear yecha ring;give byj kunlun qin")
		wait.time(1)
