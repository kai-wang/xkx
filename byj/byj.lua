...
var.me_menpai = "桃花岛"
var.me_family = "桃花岛"
var.me_dazuo = "dazuo 50000;dazuo max"
var.me_dazuo_factor = 1.3
var.gf_money = "no"
var.task_id = "byj's task"
var.ttask_id = "byj's ttask"
var.task_auto_kill = 0
var.task_kill_flag = 0
var.dig_dummy = "lbt"
...
var.drop_gold_loc = "fly wm;e;s;s;enter dong;say 天堂有路你不走呀;d;9"
...
attack_perform_array = {
	...
	[13] = { i = 17,
			action = function()
			    local wp = choose_xuedao()
				choose_force()
				Execute("unwield all;enable dodge xuanfeng-tui;enable blade xue-dao;wield " .. wp .. ";jiali max;perform unarmed.kuangfeng " .. var.pfm_target .. ";jiali 0;unwield all")
			end
	},
...
attack_list2 = { 5, 14, 10, 7, 11 }	-- xiao
...
function customize_task_pfm(menpai)
	if(menpai ~= nil) then
		local re = rex.new("(桃花|少林|峨嵋|峨眉|星宿)")
